          ...
          <div className="flex items-center gap-1 rounded-full p-1.5 bg-transparent shadow-none">
            ...
            >
              ...
              {unreadMessagesCount > 0 && (
                <span className="absolute -top-0.5 -right-0.5 bg-red-500 text-white text-[9px] font-black w-4 h-4 flex items-center justify-center rounded-full border border-white dark:border-zinc-900 shadow-sm animate-bounce">
                  {unreadMessagesCount}
                </span>
              )}
            </Button>
        ...
        <div className={cn("flex items-center gap-2 md:hidden pointer-events-auto transition-all duration-300", isIslandActive ? "opacity-0 scale-95 pointer-events-none" : "opacity-100 scale-100")}>
          <div className="flex items-center gap-1 rounded-full p-1.5 bg-transparent shadow-none">
            ...
            <Button
              ...
              className="relative rounded-full shadow-none border-none bg-transparent hover:bg-zinc-100 dark:hover:bg-zinc-800 w-9 h-9 flex text-zinc-600 hover:text-zinc-900 dark:text-zinc-300 dark:hover:text-white"
              aria-label="Messages"
            >
              <MessageSquare className="w-4 h-4" />
              {unreadMessagesCount > 0 && (
                <span className="absolute -top-0.5 -right-0.5 bg-red-500 text-white text-[9px] font-black w-4 h-4 flex items-center justify-center rounded-full border border-white dark:border-zinc-900 shadow-sm animate-pulse">
                  {unreadMessagesCount}
                </span>
              )}
            </Button>
